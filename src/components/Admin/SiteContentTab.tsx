...
export const SiteContentTab: React.FC = () => {
  ...
  return (
    <form className="space-y-6" onSubmit={(event) => {
      ...
      <Section title="Homepage hero slides" onAdd={() => setDraft((current) => ({ ...current, heroSlides: [...current.heroSlides, { id: `hero-${Date.now()}`, eyebrow: 'NEW', title: 'New campaign', description: 'Campaign description', imageUrl: '', videoUrl: '', target: 'category:all', ctaLabel: 'DISCOVER', textColor: 'light', showContent: true }] }))}>
